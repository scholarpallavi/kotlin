...
public class JetMoveTestGenerated extends AbstractJetMoveTest {
    ...
    @TestMetadata("java/moveClass/moveInnerToTop/moveNestedClassToTopLevelInTheSamePackageAndXYZ/moveNestedClassToTopLevelInTheSamePackageAndXYZ.test")
    public void testJava_moveClass_moveInnerToTop_moveNestedClassToTopLevelInTheSamePackageAndXYZ_MoveNestedClassToTopLevelInTheSamePackageAndXYZ() throws Exception {
        doTest("idea/testData/refactoring/move/java/moveClass/moveInnerToTop/moveNestedClassToTopLevelInTheSamePackageAndXYZ/moveNestedClassToTopLevelInTheSamePackageAndXYZ.test");
    }
